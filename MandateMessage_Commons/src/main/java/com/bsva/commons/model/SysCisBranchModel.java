...
public class SysCisBranchModel implements Serializable {
	...
	private static final long serialVersionUID = 1L;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			SysCisBranchModel other = (SysCisBranchModel) obj;
			if (acCreditor == null) {
		...
		public String toString() {
			return "SysCisBranchModel [branchNo=" + branchNo + ", branchName="
