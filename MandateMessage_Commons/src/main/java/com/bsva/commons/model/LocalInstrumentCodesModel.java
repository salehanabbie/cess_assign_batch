 ...
 *
 */
public class LocalInstrumentCodesModel implements Serializable
{
	...
	public LocalInstrumentCodesModel()
	{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LocalInstrumentCodesModel other = (LocalInstrumentCodesModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "LocalInstrumentCodesModel [localInstrumentCode="
				+ localInstrumentCode + ", instCodeDescription="
				+ instCodeDescription + ", activeInd=" + activeInd
