...
public class OpsServicesModel implements Serializable {
	...
	private static final long serialVersionUID = 1L;
		...
		public int hashCode() {
			...
			result = prime * result + ((serviceIdIn == null) ? 0 : serviceIdIn.hashCode());
			result = prime * result + ((serviceIdInDesc == null) ? 0 : serviceIdInDesc.hashCode());
			result = prime * result + ((serviceIdOut == null) ? 0 : serviceIdOut.hashCode());
			result = prime * result + ((serviceIdOutDesc == null) ? 0 : serviceIdOutDesc.hashCode());
			return result;
		}
		@Override
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			OpsServicesModel other = (OpsServicesModel) obj;
			if (activeInd == null) {
