 ...
 *
 */
public class CurrencyCodesModel implements Serializable{
...
public boolean equals(Object obj) {
	...
	if (getClass() != obj.getClass())
		return false;
	CurrencyCodesModel other = (CurrencyCodesModel) obj;
	if (activeInd == null) {
...
public String toString() {
	return "CurrencyCodesModel [countryCode=" + countryCode
			+ ", alphaCurrCode=" + alphaCurrCode + ", numCurrCode="
			+ numCurrCode + ", currCodeDesc=" + currCodeDesc + ", activeInd="
