...
public class SchedulerCommonsModel implements Serializable  {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SchedulerCommonsModel other = (SchedulerCommonsModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "SchedulerCommonsModel [schedulerKey=" + schedulerKey
				+ ", schedulerName=" + schedulerName + ", rescheduleTime="
				+ rescheduleTime + ", activeInd=" + activeInd + "]";
	}
