 ...
 * @author ElelwaniR
 */
public class MandatesCountCommonsModel  implements Serializable 

{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MandatesCountCommonsModel other = (MandatesCountCommonsModel) obj;
		if (fileName == null) {
	...
	public String toString() {
		return "MandatesCountCommonsModel [instId=" + instId + ", serviceId="
