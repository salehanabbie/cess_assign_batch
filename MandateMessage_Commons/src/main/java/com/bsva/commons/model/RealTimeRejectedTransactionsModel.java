...
public class RealTimeRejectedTransactionsModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RealTimeRejectedTransactionsModel other = (RealTimeRejectedTransactionsModel) obj;
		if (NoTxns == null) {
	...
	public String toString() {
		return "RealTimeRejectedTransactionsModel [rescode=" + rescode + ", mndtRejectionReason=" + mndtRejectionReason
				+ ", memberNumber=" + memberNumber + ", NoTxns=" + NoTxns + "]";
	}
