...
public class SysctrlCompParamModel implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result + ((achInstId == null) ? 0 : achInstId.hashCode());
		...
		result = prime * result + ((compAbbrevName == null) ? 0 : compAbbrevName.hashCode());
		...
		result = prime * result + ((lastFileNr == null) ? 0 : lastFileNr.hashCode());
		...
		result = prime * result + ((transamissionInd == null) ? 0 : transamissionInd.hashCode());
		return result;
	}
	@Override
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SysctrlCompParamModel other = (SysctrlCompParamModel) obj;
		if (achId == null) {
			if (other.achId != null)
				return false;
	...
	public String toString() {
		return "SysctrlCompParamModel [compId=" + compId + ", compName=" + compName + ", compAbbrevName="
				+ compAbbrevName + ", registrationNr=" + registrationNr + ", activeInd=" + activeInd + ", address1="
				+ address1 + ", address2=" + address2 + ", city=" + city + ", postCode=" + postCode + ", dialCode="
				+ dialCode + ", telNr=" + telNr + ", faxCode=" + faxCode + ", faxNr=" + faxNr + ", email=" + email
				+ ", contactName=" + contactName + ", lastFileNr=" + lastFileNr + ", transamissionInd="
				+ transamissionInd + ", bicCode=" + bicCode + ", achId=" + achId + ", achInstId=" + achInstId + "]";
	}
