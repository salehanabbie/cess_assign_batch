 ...
 *
 */
public class GrpHdrModel implements Serializable
{
    /**
	 * 
	 */
	...
	public GrpHdrModel(String msgId2) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		GrpHdrModel other = (GrpHdrModel) obj;
		if (authCode == null) {
	...
	public String toString() {
		return "GrpHdrModel [msgId=" + msgId + ", createDateTime="
