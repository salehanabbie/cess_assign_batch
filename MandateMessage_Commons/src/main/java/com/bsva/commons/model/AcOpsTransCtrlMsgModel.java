...
public class AcOpsTransCtrlMsgModel implements Serializable {
	...
	public AcOpsTransCtrlMsgModel()
	{
		super();
	}

	public AcOpsTransCtrlMsgModel(BigDecimal ctrlMsgId) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AcOpsTransCtrlMsgModel other = (AcOpsTransCtrlMsgModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "AcOpsTransCtrlMsgModel [ctrlMsgId=" + ctrlMsgId
