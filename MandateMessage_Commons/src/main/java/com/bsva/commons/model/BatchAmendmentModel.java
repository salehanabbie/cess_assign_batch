...
public class BatchAmendmentModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchAmendmentModel other = (BatchAmendmentModel) obj;
	...
	public String toString() {
		return "BatchAmendmentModel [creditor=" + creditor + ", reqByCustomer=" + reqByCustomer
