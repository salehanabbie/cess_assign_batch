...
public class CompParamModel {
	   ...
	   private BigDecimal compId;
		...
		public int hashCode() {
			...
			result = prime * result
					+ ((bicCode == null) ? 0 : bicCode.hashCode());
			result = prime * result + ((city == null) ? 0 : city.hashCode());
			result = prime
					* result
					+ ((compAbbrevName == null) ? 0 : compAbbrevName.hashCode());
			result = prime * result
					+ ((compId == null) ? 0 : compId.hashCode());
			result = prime * result
			...
			result = prime * result
					+ ((faxCode == null) ? 0 : faxCode.hashCode());
			...
			result = prime
					* result
					+ ((transamissionInd == null) ? 0 : transamissionInd
							.hashCode());
			return result;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			CompParamModel other = (CompParamModel) obj;
			if (achId == null) {
				if (other.achId != null)
					return false;
		...
		public String toString() {
			return "CompParamModel [compId=" + compId + ", compName="
					...
					+ ", dialCode=" + dialCode + ", telNr=" + telNr
					+ ", faxCode=" + faxCode + ", faxNr=" + faxNr + ", email="
					+ email + ", contactName=" + contactName + ", lastFileNr="
					+ lastFileNr + ", transamissionInd=" + transamissionInd
					+ ", bicCode=" + bicCode + ", achId=" + achId + "]";
		}
