...
public class BatchOustandingResponseModel  implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchOustandingResponseModel other = (BatchOustandingResponseModel) obj;
	...
	public String toString() {
		return "BatchOustandingResponseModel [debtorBank=" + debtorBank + ", creditorBank=" + creditorBank
