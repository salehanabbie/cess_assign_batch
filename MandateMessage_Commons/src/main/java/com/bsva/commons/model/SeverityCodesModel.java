...
public class SeverityCodesModel implements Serializable {
	...
	private static final long serialVersionUID = 1L;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			SeverityCodesModel other = (SeverityCodesModel) obj;
			if (activeInd == null) {
		...
		public String toString() {
			return "SeverityCodesModel [severityCode=" + severityCode
