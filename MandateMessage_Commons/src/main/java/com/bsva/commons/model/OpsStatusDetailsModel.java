...
public class OpsStatusDetailsModel implements Serializable
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OpsStatusDetailsModel other = (OpsStatusDetailsModel) obj;
		if (endToEndId == null) {
	...
	public String toString() {
		return "OpsStatusDetailsModel [systemSeqNo=" + systemSeqNo + ", statusHdrSeqNo=" + statusHdrSeqNo
  ...
  /*  
	...
	@Override
	public String toString() {
		return "OpsStatusDetailsModel [systemSeqNo=" + systemSeqNo
