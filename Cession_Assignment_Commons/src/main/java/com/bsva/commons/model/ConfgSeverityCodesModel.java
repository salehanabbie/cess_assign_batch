...
public class ConfgSeverityCodesModel implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ConfgSeverityCodesModel other = (ConfgSeverityCodesModel) obj;
		if (action == null) {
	...
	public String toString() {
		return "WebConfgSeverityCodesModel [severityCode=" + severityCode
				+ ", severityCodeDesc=" + severityCodeDesc + ", action="
				+ action + ", createdBy=" + createdBy + ", createdDate="
