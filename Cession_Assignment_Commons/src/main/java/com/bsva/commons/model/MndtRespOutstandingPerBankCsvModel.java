...
public class MndtRespOutstandingPerBankCsvModel implements Serializable {
	...
	private String nrDaysOutstanding;
	...
	public String getNrDaysOutstanding() {
		return nrDaysOutstanding;
	}
	public void setNrDaysOutstanding(String nrDaysOutstanding) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MndtRespOutstandingPerBankCsvModel other = (MndtRespOutstandingPerBankCsvModel) obj;
	...
	public String toString() {
		return "MndtRespOutstandingPerBankCsvModel [crdMemberName=" + crdMemberName + ", crdMemberNo=" + crdMemberNo
				+ ", fileName=" + fileName + ", transType=" + transType + ", nrDaysOutstanding=" + nrDaysOutstanding
				+ ", mandateReqTransId=" + mandateReqTransId + ", serviceId=" + serviceId + ", createdDate="
				+ createdDate + ", dbtrMemberName=" + dbtrMemberName + ", dbtrMemberNo=" + dbtrMemberNo + "]";
	}
}
