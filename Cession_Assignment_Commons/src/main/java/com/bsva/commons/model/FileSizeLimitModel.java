 ...
 *
 */
public class FileSizeLimitModel implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileSizeLimitModel other = (FileSizeLimitModel) obj;
		if (activeId == null) {
	...
	public String toString() {
		return "FileSizeLimitModel [memberId=" + memberId + ", subService=" + subService + ", processDate="
