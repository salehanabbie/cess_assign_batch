...
public class FileStatusCommonsModel  implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileStatusCommonsModel other = (FileStatusCommonsModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "FileStatusCommonsModel [status=" + status
