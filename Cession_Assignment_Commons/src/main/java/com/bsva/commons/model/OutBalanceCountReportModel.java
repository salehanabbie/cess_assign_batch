...
public class OutBalanceCountReportModel implements Serializable{
	...
	public OutBalanceCountReportModel()
	{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OutBalanceCountReportModel other = (OutBalanceCountReportModel) obj;
		if (difference == null) {
	...
	public String toString() {
		return "OutBalanceCountReportModel [nrMsgsRejected=" + nrMsgsRejected
				+ ", nrMsgsAccepted=" + nrMsgsAccepted + ", nrMsgsExtracted="
				+ nrMsgsExtracted + ", totalNrOfMsgs=" + totalNrOfMsgs
				+ ", difference=" + difference + ", inServiceId=" + inServiceId
				+ ", outServiceId=" + outServiceId + ", extServiceId="
				+ extServiceId + "]";
	}
