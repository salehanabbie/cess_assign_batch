...
public class TransCtrlMsgModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TransCtrlMsgModel other = (TransCtrlMsgModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "TransCtrlMsgModel [ctrlMsgId=" + ctrlMsgId + ", serviceId="
