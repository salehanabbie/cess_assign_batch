...
public class FrequencyCodesModel  implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FrequencyCodesModel other = (FrequencyCodesModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "FrequencyCodesModel [frequencyCode=" + frequencyCode
