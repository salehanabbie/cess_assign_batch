 ...
 *
 */
public class SystemParameterModel  implements Serializable {
...
/*
	...
	public SystemParameterModel(String sysName) {
		super();
...
*/
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SystemParameterModel other = (SystemParameterModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "SystemParameterModel [sysName=" + sysName + ", defCurr=" + defCurr + ", inactiveDuration="
				...
				+ responsePeriod + ", iamPort=" + iamPort + ",itemLimit="+ itemLimit +"]";
	}
