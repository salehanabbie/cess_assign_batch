...
public class RealTimeAmendmentModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RealTimeAmendmentModel other = (RealTimeAmendmentModel) obj;
	...
	public String toString() {
		return "RealTimeAmendmentModel [creditor=" + creditor + ", reqByCustomer=" + reqByCustomer
