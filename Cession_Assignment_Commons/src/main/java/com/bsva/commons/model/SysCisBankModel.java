 ...
 *
 */
public class SysCisBankModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SysCisBankModel other = (SysCisBankModel) obj;
		if (acCreditor == null) {
	...
	public String toString() {
		return "SysCisBankModel [memberName=" + memberName + ", maxNrRecords="
				+ maxNrRecords + ", nrOfDaysProc=" + nrOfDaysProc
				+ ", pubHolProc=" + pubHolProc + ", memberNo=" + memberNo
				+ ", acDebtor=" + acDebtor + ", acCreditor=" + acCreditor + "]";
	}
