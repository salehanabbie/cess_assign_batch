...
public class BatchRejectedTransactionModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		BatchRejectedTransactionModel other = (BatchRejectedTransactionModel) obj;
		if (NoTxns == null) {
	...
	public String toString() {
		return "BatchRejectedTransactionModel [rescode=" + rescode + ", mndtRejectionReason=" + mndtRejectionReason
