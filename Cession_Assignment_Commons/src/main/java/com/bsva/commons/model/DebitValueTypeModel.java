 ...
 *
 */
public class DebitValueTypeModel implements Serializable
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DebitValueTypeModel other = (DebitValueTypeModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "DebitValueTypeModel [debValueTypeCode=" + debValueTypeCode
				+ ", debValueTypeDesc=" + debValueTypeDesc + ", activeInd="
