...
public class OpsCronTimeModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OpsCronTimeModel other = (OpsCronTimeModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "OpsCronTimeModel [processName=" + processName + ", cronTime="
