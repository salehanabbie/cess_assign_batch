...
public class CisBranchModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CisBranchModel other = (CisBranchModel) obj;
	...
	public String toString() {
		return "CisBranchModel [branchNo=" + branchNo + ", branchName="
				+ branchName + ", division=" + division + ", abbrDivisionName="
				+ abbrDivisionName + ", agencyBranchNo=" + agencyBranchNo
				+ ", memberNo=" + memberNo + ", institutionType="
				+ institutionType + ", addressLine1=" + addressLine1
