 ...
 *
 */
public class OpsStatusHdrsModel implements Serializable 
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OpsStatusHdrsModel other = (OpsStatusHdrsModel) obj;
	...
	public String toString() {
		return "OpsStatusHdrsModel [systemSeqNo=" + systemSeqNo + ", hdrMsgId="
				+ hdrMsgId + ", createDateTime=" + createDateTime
				+ ", instdAgt=" + instdAgt + ", instgAgt=" + instgAgt
				+ ", orgnlMsgId=" + orgnlMsgId + ", orgnlMsgName="
