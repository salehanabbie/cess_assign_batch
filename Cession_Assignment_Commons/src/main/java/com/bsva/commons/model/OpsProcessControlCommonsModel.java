...
public class OpsProcessControlCommonsModel  implements Serializable {
	...
	public OpsProcessControlCommonsModel() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OpsProcessControlCommonsModel other = (OpsProcessControlCommonsModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "OpsProcessControlCommonsModel [instId=" + instId
