...
public class EntryClassesModel implements Serializable
{
	...
	private static final long serialVersionUID = 1L;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			EntryClassesModel other = (EntryClassesModel) obj;
			if (activeInd == null) {
		...
		public String toString() {
			return "MdtCnfgEntryClassesModel [entryClass=" + entryClass + ", entryClassDesc=" + entryClassDesc
