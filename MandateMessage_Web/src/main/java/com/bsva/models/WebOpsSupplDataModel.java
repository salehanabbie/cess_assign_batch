...
public class WebOpsSupplDataModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebOpsSupplDataModel other = (WebOpsSupplDataModel) obj;
		if (createdBy == null) {
	...
	public String toString() {
		return "WebOpsSupplDataModel [mandateReqId=" + mandateReqId
				+ ", placeAndName=" + placeAndName + ", envelope=" + envelope
