...
public class WebAmendmentCodesModel implements Serializable 
{
    ...
    public WebAmendmentCodesModel(String amendmentCodes)
    {
    	this.amendmentCodes = amendmentCodes;
    }
    
    public WebAmendmentCodesModel()
    {
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAmendmentCodesModel other = (WebAmendmentCodesModel) obj;
		if (activeInd == null) {
	...
	{
		return "WebAmendmentCodesModel [amendmentCodes=" + amendmentCodes
