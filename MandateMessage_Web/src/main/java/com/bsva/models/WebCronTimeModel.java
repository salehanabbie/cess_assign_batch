...
public class WebCronTimeModel implements Serializable {
	...
	public WebCronTimeModel() {
		super();
	}


	public WebCronTimeModel(String processName) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebCronTimeModel other = (WebCronTimeModel) obj;
		if (activeInd == null) {
