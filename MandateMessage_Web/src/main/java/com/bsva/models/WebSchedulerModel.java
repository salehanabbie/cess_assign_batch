...
public class WebSchedulerModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebSchedulerModel other = (WebSchedulerModel) obj;
		if (cron == null) {
			if (other.cron != null)
				return false;
	...
	public String toString() {
		return "WebSchedulerModel [scheduler=" + scheduler
				+ ", lastExecutTime=" + lastExecutTime + ", nextExecutTime="
				+ nextExecutTime + ", cron=" + cron + ", status=" + status
				+ "]";
	}
