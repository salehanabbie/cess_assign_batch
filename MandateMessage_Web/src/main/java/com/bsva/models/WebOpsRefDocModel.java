...
public class WebOpsRefDocModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebOpsRefDocModel other = (WebOpsRefDocModel) obj;
		if (code == null) {
			if (other.code != null)
				return false;
	...
	public String toString() {
		return "WebOpsRefDocModel [mandateReqId=" + mandateReqId + ", code="
