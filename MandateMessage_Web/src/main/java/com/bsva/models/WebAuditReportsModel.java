...
public class WebAuditReportsModel implements Serializable 
{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAuditReportsModel other = (WebAuditReportsModel) obj;
		if (activeInd == null) {
	...
	{
		return "WebAuditReportsModel [reportNr=" + reportNr + ", reportName="
