 ...
 *
 */
public class WebOpsCashAccountIdModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebOpsCashAccountIdModel other = (WebOpsCashAccountIdModel) obj;
	...
	public String toString() {
		return "WebOpsCashAccountIdModel [mandateReqId=" + mandateReqId
