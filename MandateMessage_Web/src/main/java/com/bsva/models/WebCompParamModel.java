 ...
 *
 */
public class WebCompParamModel {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebCompParamModel other = (WebCompParamModel) obj;
		if (achId == null) {
			if (other.achId != null)
				return false;
	...
	public String toString() {
		return "WebCompParamModel [compId=" + compId + ", compName=" + compName
