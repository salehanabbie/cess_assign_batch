...
public class WebAuthTypeModel   implements Serializable
{
	...
	public WebAuthTypeModel() 
	{
		super();
	}

	public WebAuthTypeModel(String authType) 
	{
		super();
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAuthTypeModel other = (WebAuthTypeModel) obj;
		if (activeInd == null) {
	...
	{
		return "WebAuthTypeModel [authType=" + authType
