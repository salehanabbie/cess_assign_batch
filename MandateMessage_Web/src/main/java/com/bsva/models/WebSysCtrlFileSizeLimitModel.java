 ...
 *
 */
public class WebSysCtrlFileSizeLimitModel implements Serializable {
	...
	public WebSysCtrlFileSizeLimitModel(String memberId,String subService) {
		 this.memberId =  memberId;
		 this.subService = subService;
	
	}
	
	public WebSysCtrlFileSizeLimitModel() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebSysCtrlFileSizeLimitModel other = (WebSysCtrlFileSizeLimitModel) obj;
		if (activeId == null) {
	...
	public String toString() {
		return "WebSysCtrlFileSizeLimitModel [memberId=" + memberId + ", subService=" + subService + ", limit=" + limit
