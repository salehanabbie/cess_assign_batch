...
public class WebAuditCtrlCompParamModel implements Serializable
{
	...
	public WebAuditCtrlCompParamModel()
	{
		super();
	}
	...
	public void setAchId(String achId)
{
	...
	public boolean equals(Object obj) 
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAuditCtrlCompParamModel other = (WebAuditCtrlCompParamModel) obj;
		if (achId == null) {
			if (other.achId != null)
				return false;
	...
	{
		return "WebAuditCtrlCompParamModel [achId=" + achId + ", activeInd="
