...
public class WebStatusReasonCodesModel implements Serializable{
    ...
    public WebStatusReasonCodesModel (String statusReasonCode)
    {
    	this.statusReasonCode = statusReasonCode;
    }
    
    public WebStatusReasonCodesModel()
    {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebStatusReasonCodesModel other = (WebStatusReasonCodesModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "WebStatusReasonCodesModel [statusReasonCode="
				+ statusReasonCode + ", statusReasonCodeDescription="
