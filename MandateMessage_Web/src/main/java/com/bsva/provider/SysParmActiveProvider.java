...
public class SysParmActiveProvider extends SortableDataProvider 
{	
	...
	public SysParmActiveProvider() 
	{
		controller = new Controller();
		setSort("processDate", SortOrder.ASCENDING);
		systemParameterModelList = (List<SystemParameterModel>) controller.retrieveAllActiveInd();
