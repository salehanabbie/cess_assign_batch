...
import com.bsva.provider.DelDeliveryProvider.SortableDataProviderComparator;
 ...
 *
 */
public class ViewFileStatusIncomingProvider  extends SortableDataProvider{
...
{  
	...
	public static Logger log = Logger.getLogger(DelDeliveryProvider.class);
		
	
	public ViewFileStatusIncomingProvider()
	{
		...
		opsFileRegList = (List<OpsFileRegModel>) controller.viewOpsFileRegByDirection("I","TD");
	...
	public ViewFileStatusIncomingProvider(String memberNo, String service)
	{
		controller = new Controller();
		setSort("fileName", SortOrder.ASCENDING);
