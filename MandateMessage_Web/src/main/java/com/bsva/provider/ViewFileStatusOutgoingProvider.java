 ...
 *
 */
public class ViewFileStatusOutgoingProvider  extends SortableDataProvider{
	...
	public ViewFileStatusOutgoingProvider()
	{
		...
		opsFileRegList = (List<OpsFileRegModel>) controller.viewOpsFileRegByDirection("O","TD");
	...
	public ViewFileStatusOutgoingProvider(String fileName)
	{
	...
	public ViewFileStatusOutgoingProvider(String memberNo, String service)
	{
		controller = new Controller();
		setSort("fileName", SortOrder.ASCENDING);
		opsFileRegList=new ArrayList<OpsFileRegModel>();
