...
public class ViewOutgoingFilesProvider extends SortableDataProvider
{
	...
	public static Logger log = Logger.getLogger(ViewOutgoingFilesProvider.class);
	
	public ViewOutgoingFilesProvider()
	{
		controller = new Controller();
		
		setSort("fileName", SortOrder.ASCENDING);
		opsFileRegList = (List<OpsFileRegModel>) controller.retrieveOpsFileRegbyDerictionCriteria("O");
	...
	public ViewOutgoingFilesProvider(String memberNo, String service)
	{
	...
	public ViewOutgoingFilesProvider(String fileName)
	{
		controller = new Controller();
