...
public class MandatesSearchEntityModel implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MandatesSearchEntityModel other = (MandatesSearchEntityModel) obj;
		if (fiName == null) {
	...
	public String toString() {
		return "MandatesSearchEntityModel [mandateId=" + mandateId + ", name="
				+ name + ", fiName=" + fiName + ", partyId=" + partyId
				+ ", finId=" + finId + "]";
	}
