...
public class AuditTrackingEntityModel implements Serializable{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AuditTrackingEntityModel other = (AuditTrackingEntityModel) obj;
		if (action == null) {
	...
	public String toString() {
		return "AuditTrackingEntityModel [actionDate=" + actionDate
