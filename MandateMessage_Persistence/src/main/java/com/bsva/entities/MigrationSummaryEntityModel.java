...
public class MigrationSummaryEntityModel implements Serializable{
	...
	public MigrationSummaryEntityModel() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MigrationSummaryEntityModel other = (MigrationSummaryEntityModel) obj;
		if (memberNo == null) {
	...
	public String toString() {
		return "MigrationSummaryEntityModel [nrOfNaedoRequest=" + nrOfNaedoRequest + ", nrofNaedoSuccessfulRequest="
