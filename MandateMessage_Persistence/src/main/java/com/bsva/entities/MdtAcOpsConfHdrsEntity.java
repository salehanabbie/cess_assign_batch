...
import org.hibernate.annotations.Parameter;
	 ...
	 */
	@Entity
	@Table(name = "MDT_AC_OPS_CONF_HDRS",schema = "MANOWNER")
	@XmlRootElement
	@NamedQueries({
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findAll", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findBySystemSeqNo", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.systemSeqNo = :systemSeqNo"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByHdrMsgId", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.hdrMsgId = :hdrMsgId"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByCreateDateTime", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.createDateTime = :createDateTime"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByInstgAgt", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.instgAgt = :instgAgt"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByInstdAgt", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.instdAgt = :instdAgt"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByOrgnlMsgId", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.orgnlMsgId = :orgnlMsgId"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByOrgnlMsgName", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.orgnlMsgName = :orgnlMsgName"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByOrgnlCreateDateTime", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.orgnlCreateDateTime = :orgnlCreateDateTime"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByProcessStatus", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.processStatus = :processStatus"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByGroupStatus", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.groupStatus = :groupStatus"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByService", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.service = :service"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByGroupError", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.groupError = :groupError"),
	    @NamedQuery(name = "MdtAcOpsConfHdrsEntity.findByExcessPeriod", query = "SELECT m FROM MdtAcOpsConfHdrsEntity m WHERE m.createDateTime <= :createDateTime")})
	public class MdtAcOpsConfHdrsEntity implements Serializable {
	    ...
	    public MdtAcOpsConfHdrsEntity() {
	    }

	    public MdtAcOpsConfHdrsEntity(BigDecimal systemSeqNo) {
	        this.systemSeqNo = systemSeqNo;
	    }

	    public MdtAcOpsConfHdrsEntity(BigDecimal systemSeqNo, String hdrMsgId) {
	        this.systemSeqNo = systemSeqNo;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			MdtAcOpsConfHdrsEntity other = (MdtAcOpsConfHdrsEntity) obj;
		...
		public String toString() {
			return "MdtAcOpsConfHdrsEntity [systemSeqNo=" + systemSeqNo
