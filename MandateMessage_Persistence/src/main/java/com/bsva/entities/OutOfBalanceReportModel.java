...
public class OutOfBalanceReportModel implements Serializable {
   ...
   private BigDecimal nrMsgsAccepted;
	...
	public OutOfBalanceReportModel() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OutOfBalanceReportModel other = (OutOfBalanceReportModel) obj;
	...
	public String toString() {
		return "OutOfBalanceReportModel [serviceId=" + serviceId
