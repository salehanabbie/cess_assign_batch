...
public class MandatesReportsEntityModel implements Serializable {
	...
	public MandatesReportsEntityModel() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MandatesReportsEntityModel other = (MandatesReportsEntityModel) obj;
		if (collAmount == null) {
	...
	public String toString() {
		return "MandatesReportsModel [mandateId=" + mandateId
