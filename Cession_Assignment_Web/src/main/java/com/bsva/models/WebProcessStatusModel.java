...
public class WebProcessStatusModel implements Serializable{
	...
	public WebProcessStatusModel(String status2) {
		
	}

	public WebProcessStatusModel() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WebProcessStatusModel other = (WebProcessStatusModel) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "WebProcessStatusModel [status=" + status
