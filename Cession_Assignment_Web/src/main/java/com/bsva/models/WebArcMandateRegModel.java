...
public class WebArcMandateRegModel implements Serializable 
{
	...
	public BigDecimal getMaxAmount()
{
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebArcMandateRegModel other = (WebArcMandateRegModel) obj;
		if (activeInd == null) {
	...
	{
		return "WebArcMandateRegModel [msgId=" + msgId + ", mandateId="
				+ mandateId + ", mandateReqId=" + mandateReqId
				+ ", sequenceType=" + sequenceType + ", frequency=" + frequency
				+ ", fromDate=" + fromDate + ", toDate=" + toDate
				+ ", firstCollDate=" + firstCollDate + ", finalCollDate="
				+ finalCollDate + ", collCurrency=" + collCurrency
				+ ", collAmount=" + collAmount + ", maxAmountCurr="
				+ maxAmountCurr + ", maxAmount=" + maxAmount
				+ ", localInstrCd=" + localInstrCd + ", serviceLevel="
				+ serviceLevel + ", status=" + status + ", activeInd="
				+ activeInd + ", activeIndChangeDate=" + activeIndChangeDate
