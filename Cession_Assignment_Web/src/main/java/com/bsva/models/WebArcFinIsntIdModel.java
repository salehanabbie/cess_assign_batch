 ...
 *
 */
public class WebArcFinIsntIdModel implements Serializable
{	
	  ...
	  private String finInstTypeId;
		...
		public boolean equals(Object obj)
		{
			...
			if (getClass() != obj.getClass())
				return false;
			WebArcFinIsntIdModel other = (WebArcFinIsntIdModel) obj;
		...
		{
			return "WebArcFinIsntIdModel [mandateReqId=" + mandateReqId
