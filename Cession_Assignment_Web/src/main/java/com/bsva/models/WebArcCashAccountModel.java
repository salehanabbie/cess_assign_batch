 ...
 *
 */
public class WebArcCashAccountModel implements Serializable
{
		...
		public boolean equals(Object obj) 
		{
			...
			if (getClass() != obj.getClass())
				return false;
			WebArcCashAccountModel other = (WebArcCashAccountModel) obj;
			if (accountName == null) {
		...
		{
			return "WebArcCashAccountModel [mandateReqId=" + mandateReqId
					+ ", accountNumber=" + accountNumber + ", accountType="
					+ accountType + ", currency=" + currency + ", accountName="
					+ accountName + ", createdBy=" + createdBy
