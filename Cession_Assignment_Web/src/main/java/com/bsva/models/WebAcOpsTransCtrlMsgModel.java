...
public class WebAcOpsTransCtrlMsgModel  implements Serializable
{
	/**
	 * @author ElelwaniR
	 */
	...
	public WebAcOpsTransCtrlMsgModel() 
	{
		super();
	}
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAcOpsTransCtrlMsgModel other = (WebAcOpsTransCtrlMsgModel) obj;
		if (activeInd == null) {
	...
	{
		return "WebAcOpsTransCtrlMsgModel [ctrlMsgId=" + ctrlMsgId
