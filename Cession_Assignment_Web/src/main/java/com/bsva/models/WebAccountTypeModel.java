 ...
 *
 */
public class WebAccountTypeModel implements Serializable
{
    ...
    public WebAccountTypeModel (String accountTypeCode)
    {
    	this.accountTypeCode = accountTypeCode;
    }
    
    public WebAccountTypeModel()
    {
	...
	public boolean equals(Object obj) 
	{
		...
		if (getClass() != obj.getClass())
			return false;
		WebAccountTypeModel other = (WebAccountTypeModel) obj;
	...
	{
		return accountTypeCode + " - " + accountTypeDescription;
				
				/*"WebAccountTypeModel [accountTypeCode=" + accountTypeCode
