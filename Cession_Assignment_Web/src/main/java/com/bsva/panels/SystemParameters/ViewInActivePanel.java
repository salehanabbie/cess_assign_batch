...
import com.bsva.provider.SysParmInActiveProvider;

public class ViewInActivePanel extends Panel implements Serializable{

	
	private static final long serialVersionUID = 1L;
	Controller controller;
	public static Logger log = Logger.getLogger(ViewInActivePanel.class);
	...
	public ViewInActivePanel(String id) 
	{
		super(id);
		this.id = id;
	...
	private void initialiazeComponents() 
	{
		...
		form = new Form("ViewInActivePanel");
		form.add(createDataTable(new SysParmInActiveProvider()));		
	...
	private DefaultDataTable createDataTable(SysParmInActiveProvider sysParmInActiveProvider)
	{
...
//		columns.add(new PropertyColumn(new Model<String>("Easter Days Ind"),"easterDaysInd", "easterDaysInd"));
		...
		dataTable = new DefaultDataTable("dataTable",columns, sysParmInActiveProvider, 10);
		return dataTable;
