...
@Entity
@Table(name = "MDT_AC_OPS_STATUS_HDRS",schema = "MANOWNER")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findAll", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findBySystemSeqNo", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.systemSeqNo = :systemSeqNo"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByHdrMsgId", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.hdrMsgId = :hdrMsgId"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByCreateDateTime", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.createDateTime = :createDateTime"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByInstgAgt", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.instgAgt = :instgAgt"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByInstdAgt", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.instdAgt = :instdAgt"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlMsgId", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlMsgId = :orgnlMsgId"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlMsgName", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlMsgName = :orgnlMsgName"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlCreateDateTime", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlCreateDateTime = :orgnlCreateDateTime"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlNoOfTxns", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlNoOfTxns = :orgnlNoOfTxns"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlCntlSum", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlCntlSum = :orgnlCntlSum"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByProcessStatus", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.processStatus = :processStatus"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByIN", query = "SELECT o FROM MdtAcOpsStatusHdrsEntity o WHERE o.processStatus IN (:processStatus1, :processStatus2)"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByServiceIdIN", query = "SELECT o FROM MdtAcOpsStatusHdrsEntity o WHERE o.service IN (:service1, :service2)"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByGroupStatus", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.groupStatus = :groupStatus"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByService", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.service = :service"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByVetRunNumber", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.vetRunNumber = :vetRunNumber"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByWorkunitRefNo", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.workunitRefNo = :workunitRefNo"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByProStatusAndService", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.service = :service and m.processStatus = :processStatus and TRUNC(m.createDateTime) = TO_DATE(:createDateTime,'YYYY-MM-DD') and m.instgAgt = :memberId"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByOrgnlFileName", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.orgnlFileName = :orgnlFileName"),
    @NamedQuery(name = "MdtAcOpsStatusHdrsEntity.findByExtractFileName", query = "SELECT m FROM MdtAcOpsStatusHdrsEntity m WHERE m.extractFileName = :extractFileName")})
public class MdtAcOpsStatusHdrsEntity implements Serializable {
    ...
    @GenericGenerator(name = "generator", strategy = "sequence-identity", parameters = @Parameter(name = "sequence", value = "MANOWNER.MDT_AC_OPS_STATUS_HDRS_SEQ") )
    ...
    public MdtAcOpsStatusHdrsEntity() {
    }

    public MdtAcOpsStatusHdrsEntity(BigDecimal systemSeqNo) {
        this.systemSeqNo = systemSeqNo;
    }

    public MdtAcOpsStatusHdrsEntity(BigDecimal systemSeqNo, String hdrMsgId) {
        this.systemSeqNo = systemSeqNo;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MdtAcOpsStatusHdrsEntity other = (MdtAcOpsStatusHdrsEntity) obj;
	...
	public String toString() {
		return "MdtAcOpsStatusHdrsEntity [systemSeqNo=" + systemSeqNo + ", hdrMsgId=" + hdrMsgId + ", createDateTime="
