 ...
 */
@Embeddable
public class CasOpsCessionAssignEntityPK implements Serializable {
    ...
    public CasOpsCessionAssignEntityPK() {
    }

    public CasOpsCessionAssignEntityPK(String msgId, String mandateReqTranId) {
        this.msgId = msgId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CasOpsCessionAssignEntityPK other = (CasOpsCessionAssignEntityPK) obj;
	...
	public String toString() {
		return "CasOpsCessionAssignEntityPK [msgId=" + msgId + ", mandateReqTranId=" + mandateReqTranId + "]";
	}
