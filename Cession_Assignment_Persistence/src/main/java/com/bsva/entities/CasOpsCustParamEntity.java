...
@NamedQueries({
    ...
    @NamedQuery(name = "CasOpsCustParamEntity.findByManInitXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manInitXsdNs = :manInitXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManInitLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manInitLstSeq = :manInitLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManInitLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manInitLastFileNr = :manInitLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAmdXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAmdXsdNs = :manAmdXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAmdLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAmdLstSeq = :manAmdLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAmdLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAmdLastFileNr = :manAmdLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManCanXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manCanXsdNs = :manCanXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManCanLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manCanLstSeq = :manCanLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManCanLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manCanLastFileNr = :manCanLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAccpXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAccpXsdNs = :manAccpXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAccpLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAccpLstSeq = :manAccpLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManAccpLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manAccpLastFileNr = :manAccpLastFileNr"),
    ...
    @NamedQuery(name = "CasOpsCustParamEntity.findByCasReqIdReuseInd", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.mdtReqIdReuseInd = :mdtReqIdReuseInd"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManStatusRepXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manStatusRepXsdNs = :manStatusRepXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManStatusRepLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manStatusRepLstSeq = :manStatusRepLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManStatusRepLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manStatusRepLastFileNr = :manStatusRepLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManReqXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manReqXsdNs = :manReqXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManReqLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manReqLstSeq = :manReqLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManReqLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manReqLastFileNr = :manReqLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManRespXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manRespXsdNs = :manRespXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManRespLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manRespLstSeq = :manRespLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManRespLastFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manRespLastFileNr = :manRespLastFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManConfirmXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manConfirmXsdNs = :manConfirmXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManConfirmLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manConfirmLstSeq = :manConfirmLstSeq"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManConfirmLstFileNr", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manConfirmLstFileNr = :manConfirmLstFileNr"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManSuspXsdNs", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manSuspXsdNs = :manSuspXsdNs"),
    @NamedQuery(name = "CasOpsCustParamEntity.findByManSuspLstSeq", query = "SELECT m FROM CasOpsCustParamEntity m WHERE m.manSuspLstSeq = :manSuspLstSeq")})
public class CasOpsCustParamEntity implements Serializable {
    ...
    public String getCasReqIdReuseInd() {
        return mdtReqIdReuseInd;
    }

    public void setCasReqIdReuseInd(String mdtReqIdReuseInd) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CasOpsCustParamEntity other = (CasOpsCustParamEntity) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "CasOpsCustParamEntity [instId=" + instId + ", manInitXsdNs="
