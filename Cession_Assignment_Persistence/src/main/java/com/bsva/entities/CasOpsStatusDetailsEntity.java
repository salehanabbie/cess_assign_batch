...
@Entity
@Table(name = "CAS_OPS_STATUS_DETAILS",schema = "CAMOWNER")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findAll", query = "SELECT m FROM CasOpsStatusDetailsEntity m"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findBySystemSeqNo", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.systemSeqNo = :systemSeqNo"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByStatusHdrSeqNo", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.statusHdrSeqNo = :statusHdrSeqNo"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByErrorCode", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.errorCode = :errorCode"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByTxnId", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.txnId = :txnId"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByEndToEndId", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.endToEndId = :endToEndId"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByTxnStatus", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.txnStatus = :txnStatus"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByErrorType", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.errorType = :errorType"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByRecordId", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.recordId = :recordId"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByOrgnlTxnSeqNo", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.orgnlTxnSeqNo = :orgnlTxnSeqNo"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByMandateRefNumber", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.mandateRefNumber = :mandateRefNumber"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByInstId", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.instId = :instId"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByProcessStatus", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.processStatus = :processStatus"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByDebtorBranchNo", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.debtorBranchNo = :debtorBranchNo"),
    @NamedQuery(name = "CasOpsStatusDetailsEntity.findByCrAbbShortName", query = "SELECT m FROM CasOpsStatusDetailsEntity m WHERE m.crAbbShortName = :crAbbShortName")})
public class CasOpsStatusDetailsEntity implements Serializable {
    
    @Id
    @Basic(optional = false)
    @NotNull
    @GenericGenerator(name = "generator", strategy = "sequence-identity", parameters = @Parameter(name = "sequence", value = "CAMOWNER.CAS_OPS_STATUS_DETAILS_SEQ") )
    ...
    public CasOpsStatusDetailsEntity() {
    }

    public CasOpsStatusDetailsEntity(BigDecimal systemSeqNo) {
        this.systemSeqNo = systemSeqNo;
    }

    public CasOpsStatusDetailsEntity(BigDecimal systemSeqNo, BigDecimal statusHdrSeqNo) {
        this.systemSeqNo = systemSeqNo;
	   ...
	   public String getDebtorBranchNo() {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			CasOpsStatusDetailsEntity other = (CasOpsStatusDetailsEntity) obj;
		...
		public String toString() {
			return "CasOpsStatusDetailsEntity [systemSeqNo=" + systemSeqNo
