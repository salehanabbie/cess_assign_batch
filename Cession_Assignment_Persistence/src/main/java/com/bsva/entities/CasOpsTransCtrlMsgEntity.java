 ...
 */
@Entity
@Table(name = "CAS_OPS_TRANS_CTRL_MSG",schema = "CAMOWNER")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findAll", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByCtrlMsgId", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.ctrlMsgId = :ctrlMsgId"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByServiceId", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.serviceId = :serviceId"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByMsgType", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.msgType = :msgType"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByProcessDate", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.processDate = :processDate"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByMemberIdFm", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.memberIdFm = :memberIdFm"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByMemberIdTo", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.memberIdTo = :memberIdTo"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByNrOfFiles", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.nrOfFiles = :nrOfFiles"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByNrOfRecords", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.nrOfRecords = :nrOfRecords"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByValueOfRecords", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.valueOfRecords = :valueOfRecords"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findBySystemStatus", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.systemStatus = :systemStatus"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByNrOfFilesReceived", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.nrOfFilesReceived = :nrOfFilesReceived"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByNrOfRecordsReceived", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.nrOfRecordsReceived = :nrOfRecordsReceived"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByValidRecordsReceived", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.validRecordsReceived = :validRecordsReceived"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByActiveInd", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.activeInd = :activeInd"),
    @NamedQuery(name = "CasOpsTransCtrlMsgEntity.findByValueOfRecordsCurr", query = "SELECT m FROM CasOpsTransCtrlMsgEntity m WHERE m.valueOfRecordsCurr = :valueOfRecordsCurr")})
public class CasOpsTransCtrlMsgEntity implements Serializable {
    private static final long serialVersionUID = 1L;
    @GenericGenerator(name = "generator", strategy = "sequence-identity", parameters = @Parameter(name = "sequence", value = "CAMOWNER.CAS_OPS_TRANS_CTRL_MSG_SEQ") )
    ...
    public CasOpsTransCtrlMsgEntity() {
    }

    public CasOpsTransCtrlMsgEntity(BigDecimal ctrlMsgId) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CasOpsTransCtrlMsgEntity other = (CasOpsTransCtrlMsgEntity) obj;
		if (activeInd == null) {
	...
	public String toString() {
		return "CasOpsTransCtrlMsgEntity [ctrlMsgId=" + ctrlMsgId
