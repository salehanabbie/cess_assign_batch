...
public class EndOfDayReportsEntityModel  implements Serializable

{
	...
	public EndOfDayReportsEntityModel() 
	{
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EndOfDayReportsEntityModel other = (EndOfDayReportsEntityModel) obj;
		if (Incoming == null) {
	...
	public String toString() {
		return "EndOfDayReportsModel [balanceBrghtForward="
				+ balanceBrghtForward + ", Incoming=" + Incoming
				+ ", Outgoing=" + Outgoing + ", serviceID=" + serviceID
