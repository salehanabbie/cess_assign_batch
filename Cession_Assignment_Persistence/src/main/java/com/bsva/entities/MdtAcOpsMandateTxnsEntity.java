 ...
 */
@Entity
@Table(name = "MDT_AC_OPS_MANDATE_TXNS", schema="MANOWNER")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findAll", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMsgId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mdtAcOpsMandateTxnsEntityPK.msgId = :msgId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMandateReqTranId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mdtAcOpsMandateTxnsEntityPK.mandateReqTranId = :mandateReqTranId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreditorBank", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.creditorBank = :creditorBank"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtorBank", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtorBank = :debtorBank"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByServiceId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.serviceId = :serviceId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByProcessStatus", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.processStatus = :processStatus"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByInFileName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.inFileName = :inFileName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByInFileDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.inFileDate = :inFileDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByExtractMsgId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.extractMsgId = :extractMsgId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByExtractFileName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.extractFileName = :extractFileName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByInitParty", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.initParty = :initParty"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMandateId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mandateId = :mandateId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByContractRef", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.contractRef = :contractRef"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByServiceLevel", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.serviceLevel = :serviceLevel"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByLocalInstrCd", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.localInstrCd = :localInstrCd"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findBySequenceType", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.sequenceType = :sequenceType"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByFrequency", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.frequency = :frequency"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByFromDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.fromDate = :fromDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByFirstCollDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.firstCollDate = :firstCollDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCollAmountCurr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.collAmountCurr = :collAmountCurr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCollAmount", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.collAmount = :collAmount"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMaxAmountCurr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.maxAmountCurr = :maxAmountCurr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMaxAmount", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.maxAmount = :maxAmount"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredSchemeId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credSchemeId = :credSchemeId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreditorName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.creditorName = :creditorName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredPhoneNr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credPhoneNr = :credPhoneNr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredEmailAddr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credEmailAddr = :credEmailAddr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredAccNum", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credAccNum = :credAccNum"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredBranchNr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credBranchNr = :credBranchNr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByUltCredName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.ultCredName = :ultCredName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCredAbbShortName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.credAbbShortName = :credAbbShortName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtorName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtorName = :debtorName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtorId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtorId = :debtorId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtPhoneNr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtPhoneNr = :debtPhoneNr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtEmailAddr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtEmailAddr = :debtEmailAddr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtAccNum", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtAccNum = :debtAccNum"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtAccType", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtAccType = :debtAccType"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebtBranchNr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debtBranchNr = :debtBranchNr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByUltDebtName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.ultDebtName = :ultDebtName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAuthType", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.authType = :authType"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCollectionDay", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.collectionDay = :collectionDay"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDateAdjRuleInd", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.dateAdjRuleInd = :dateAdjRuleInd"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAdjCategory", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.adjCategory = :adjCategory"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAdjRate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.adjRate = :adjRate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAdjAmountCurr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.adjAmountCurr = :adjAmountCurr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAdjAmount", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.adjAmount = :adjAmount"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByFirstCollAmtCurr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.firstCollAmtCurr = :firstCollAmtCurr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByFirstCollAmt", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.firstCollAmt = :firstCollAmt"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByDebitValueType", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.debitValueType = :debitValueType"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAcceptedInd", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.acceptedInd = :acceptedInd"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByRejectReasonCode", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.rejectReasonCode = :rejectReasonCode"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAuthStatusInd", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.authStatusInd = :authStatusInd"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAuthChannel", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.authChannel = :authChannel"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMandateRefNr", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mandateRefNr = :mandateRefNr"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMandateAuthDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mandateAuthDate = :mandateAuthDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByAmendReason", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.amendReason = :amendReason"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigMandateId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origMandateId = :origMandateId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigContractRef", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origContractRef = :origContractRef"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigCredName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origCredName = :origCredName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigMandReqTranId", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origMandReqTranId = :origMandReqTranId"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigDebtName", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origDebtName = :origDebtName"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByOrigDebtBranch", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.origDebtBranch = :origDebtBranch"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCancelReason", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.cancelReason = :cancelReason"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreatedBy", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.createdBy = :createdBy"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreatedDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.createdDate = :createdDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByModifiedBy", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.modifiedBy = :modifiedBy"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByModifiedDate", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.modifiedDate = :modifiedDate"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreatedDateTruncAndServiceIdDebtor", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.serviceId = :serviceId and TRUNC(m.createdDate) = TO_DATE(:createdDate,'YYYY-MM-DD')"
//    		                                                                                   + " and (m.processStatus = :processStatus1 OR m.processStatus = :processStatus2) and (m.inFileName LIKE CONCAT('%',:memberId,'%'))")})
    ...
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByCreatedDateTruncAndServiceIdCreditor", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.serviceId = :serviceId and TRUNC(m.createdDate) = TO_DATE(:createdDate,'YYYY-MM-DD')"
    																						   + " and (m.processStatus = :processStatus1 OR m.processStatus = :processStatus2) and (m.creditorBank = :memberId)"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.findByMacCode", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.macCode = :macCode"),
    @NamedQuery(name = "MdtAcOpsMandateTxnsEntity.matchingPain012", query = "SELECT m FROM MdtAcOpsMandateTxnsEntity m WHERE m.mdtAcOpsMandateTxnsEntityPK.mandateReqTranId = :mandateReqTranId ORDER BY CASE WHEN m.serviceId = 'MANCN' THEN 1 WHEN m.serviceId = 'MANAM' THEN 2 WHEN m.serviceId = 'MANIN' THEN 3 END")})

public class MdtAcOpsMandateTxnsEntity implements Serializable {

    private static final long serialVersionUID = 1L;
    @EmbeddedId
    protected MdtAcOpsMandateTxnsEntityPK mdtAcOpsMandateTxnsEntityPK;
    @Size(max = 6)
    ...
    public MdtAcOpsMandateTxnsEntity() {
    }

    public MdtAcOpsMandateTxnsEntity(MdtAcOpsMandateTxnsEntityPK mdtAcOpsMandateTxnsEntityPK) {
        this.mdtAcOpsMandateTxnsEntityPK = mdtAcOpsMandateTxnsEntityPK;
    }

    public MdtAcOpsMandateTxnsEntity(String msgId, String mandateReqTranId) {
        this.mdtAcOpsMandateTxnsEntityPK = new MdtAcOpsMandateTxnsEntityPK(msgId, mandateReqTranId);
    }

    public MdtAcOpsMandateTxnsEntityPK getMdtAcOpsMandateTxnsEntityPK() {
        return mdtAcOpsMandateTxnsEntityPK;
    }

    public void setMdtAcOpsMandateTxnsEntityPK(MdtAcOpsMandateTxnsEntityPK mdtAcOpsMandateTxnsEntityPK) {
        this.mdtAcOpsMandateTxnsEntityPK = mdtAcOpsMandateTxnsEntityPK;
    }
	...
	public int hashCode() {
		...
		result = prime * result + ((mdtAcOpsMandateTxnsEntityPK == null) ? 0 : mdtAcOpsMandateTxnsEntityPK.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MdtAcOpsMandateTxnsEntity other = (MdtAcOpsMandateTxnsEntity) obj;
		if (acceptedInd == null) {
		...
		if (maxAmountCurr == null) {
			...
			return false;
		if (mdtAcOpsMandateTxnsEntityPK == null) {
			if (other.mdtAcOpsMandateTxnsEntityPK != null)
				return false;
		} else if (!mdtAcOpsMandateTxnsEntityPK.equals(other.mdtAcOpsMandateTxnsEntityPK))
			return false;
		if (modifiedBy == null) {
	...
	public String toString() {
		return "MdtAcOpsMandateTxnsEntity [mdtAcOpsMandateTxnsEntityPK=" + mdtAcOpsMandateTxnsEntityPK
