 ...
 */
@Entity
@Table(name = "MDT_AC_OPS_CONF_DETAILS",schema = "MANOWNER")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findAll", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findBySystemSeqNo", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.systemSeqNo = :systemSeqNo"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByConfHdrSeqNo", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.confHdrSeqNo = :confHdrSeqNo"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByErrorCode", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.errorCode = :errorCode"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByTxnId", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.txnId = :txnId"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByTxnStatus", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.txnStatus = :txnStatus"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByErrorType", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.errorType = :errorType"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByRecordId", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.recordId = :recordId"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByMandateRefNumber", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.mandateRefNumber = :mandateRefNumber"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByInstId", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.instId = :instId"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByProcessStatus", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.processStatus = :processStatus"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByExtractService", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.extractService = :extractService"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByOrgnlMsgType", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.orgnlMsgType = :orgnlMsgType"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByExtractMsgId", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.extractMsgId = :extractMsgId"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByLocalInstrCd", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.localInstrCd = :localInstrCd"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByMsgId", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.msgId = :msgId"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByInFileName", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.inFileName = :inFileName"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByExtractFileName", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.extractFileName = :extractFileName"),
    @NamedQuery(name = "MdtAcOpsConfDetailsEntity.findByExtractProcessStatusOutService", query = "SELECT m FROM MdtAcOpsConfDetailsEntity m WHERE m.processStatus = :processStatus and m.extractService = :extractService and m.instId = :memberId")})
    
public class MdtAcOpsConfDetailsEntity implements Serializable {
    ...
    public MdtAcOpsConfDetailsEntity() {
    }

    public MdtAcOpsConfDetailsEntity(BigDecimal systemSeqNo) {
        this.systemSeqNo = systemSeqNo;
    }

    public MdtAcOpsConfDetailsEntity(BigDecimal systemSeqNo, BigDecimal confHdrSeqNo) {
        this.systemSeqNo = systemSeqNo;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MdtAcOpsConfDetailsEntity other = (MdtAcOpsConfDetailsEntity) obj;
	...
	public String toString() {
		return "MdtAcOpsConfDetailsEntity [systemSeqNo=" + systemSeqNo + ", confHdrSeqNo=" + confHdrSeqNo
