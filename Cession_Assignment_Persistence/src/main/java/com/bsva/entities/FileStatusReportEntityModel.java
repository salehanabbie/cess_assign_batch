...
public class FileStatusReportEntityModel implements Serializable {
	...
	public FileStatusReportEntityModel() {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		FileStatusReportEntityModel other = (FileStatusReportEntityModel) obj;
		if (fileName == null) {
	...
	public String toString() {
		return "FileStatusReportEntityModel [fileName=" + fileName
				+ ", instId=" + instId + ", serviceId=" + serviceId
				+ ", nrOfMsgs=" + nrOfMsgs + ", status=" + status + "]";
	}
