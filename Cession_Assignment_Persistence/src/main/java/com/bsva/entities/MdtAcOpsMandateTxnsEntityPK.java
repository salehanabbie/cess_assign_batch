 ...
 */
@Embeddable
public class MdtAcOpsMandateTxnsEntityPK implements Serializable {
    ...
    public MdtAcOpsMandateTxnsEntityPK() {
    }

    public MdtAcOpsMandateTxnsEntityPK(String msgId, String mandateReqTranId) {
        this.msgId = msgId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MdtAcOpsMandateTxnsEntityPK other = (MdtAcOpsMandateTxnsEntityPK) obj;
	...
	public String toString() {
		return "MdtAcOpsMandateTxnsEntityPK [msgId=" + msgId + ", mandateReqTranId=" + mandateReqTranId + "]";
	}
