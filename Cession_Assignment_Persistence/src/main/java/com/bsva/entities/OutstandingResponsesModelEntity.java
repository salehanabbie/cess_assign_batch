...
*
*/
public class OutstandingResponsesModelEntity implements Serializable {
      ...
      * 
  	...
  	public int hashCode() {
  		...
  		result = prime * result + ((creditorMemberNo == null) ? 0 : creditorMemberNo.hashCode());
  		...
  		result = prime * result + ((mandateReqId == null) ? 0 : mandateReqId.hashCode());
  	...
  	public boolean equals(Object obj) {
  		...
  		if (getClass() != obj.getClass())
  			return false;
  		OutstandingResponsesModelEntity other = (OutstandingResponsesModelEntity) obj;
  		if (bankName == null) {
  	...
  	public String toString() {
  		return "OutstandingResponsesModel [mandateReqTranId=" + mandateReqTranId + ", mandateReqId=" + mandateReqId
  				+ ", mandateRefNr=" + mandateRefNr + ", serviceId=" + serviceId + ", bankName=" + bankName
  				+ ", creditorMemberNo=" + creditorMemberNo + ", debtorMemberNo=" + debtorMemberNo + ", fileName="
  				+ fileName + "]";
  	}
