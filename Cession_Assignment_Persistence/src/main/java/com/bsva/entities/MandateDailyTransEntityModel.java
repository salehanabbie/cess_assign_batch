...
public class MandateDailyTransEntityModel implements Serializable {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((mndtRefNumber == null) ? 0 : mndtRefNumber.hashCode());
		result = prime * result
				+ ((mndtReqId == null) ? 0 : mndtReqId.hashCode());
		result = prime * result
				+ ((mndtReqTransId == null) ? 0 : mndtReqTransId.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MandateDailyTransEntityModel other = (MandateDailyTransEntityModel) obj;
		if (actionDate == null) {
	...
	public String toString() {
		return "MandateDailyTransEntityModel [serviceId=" + serviceId
				+ ", creditorBank=" + creditorBank + ", debtorBank="
				+ debtorBank + ", extractMsgId=" + extractMsgId
				+ ", actionDate=" + actionDate + ", mndtReqId=" + mndtReqId
				+ ", mndtReqTransId=" + mndtReqTransId + ", mndtRefNumber="
				+ mndtRefNumber + ", authCode=" + authCode + ", trxnStatus="
				+ trxnStatus + "]";
	}
