 ...
 */
@Embeddable
public class CasOpsRepSeqNrPK implements Serializable {
    ...
    public CasOpsRepSeqNrPK() {
    }

    public CasOpsRepSeqNrPK(Date processDate, String memberNo, String reportNo) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CasOpsRepSeqNrPK other = (CasOpsRepSeqNrPK) obj;
		if (memberNo == null) {
	...
	public String toString() {
		return "CasOpsRepSeqNrPK [processDate=" + processDate + ", memberNo="
