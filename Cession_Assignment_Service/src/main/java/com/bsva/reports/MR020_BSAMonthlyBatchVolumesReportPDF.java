 ...
 *
 */
public class MR020_BSAMonthlyBatchVolumesReportPDF 
{
	public static Logger log=Logger.getLogger(MR020_BSAMonthlyBatchVolumesReportPDF.class);

	String mr020Name,recipientNr, reportDir = null, tempDir = null;
	...
	public void generateReport(XSSFWorkbook inputXlsWorkbook) throws FileNotFoundException, DocumentException
	{
		...
		try
		{
			...
			mr020Name = propertyUtilRemote.getPropValue("RPT.MONTHLY.BATCH.VOLUMES");
	...
	public void generateReportDetail()throws DocumentException, FileNotFoundException
	{
		...
		//add summary data 
		XSSFSheet summWorksheet = mr020xlsReport.getSheetAt(0); 
		FormulaEvaluator evaluator = mr020xlsReport.getCreationHelper().createFormulaEvaluator();
		...
		XSSFSheet inpCredWorksheet = mr020xlsReport.getSheetAt(1); 
		...
		createCreditorBankRow(cdtrDataTbl, inpCredWorksheet.getRow(15).getCell(0).toString(), inpCredWorksheet.getRow(15).getCell(1).toString(), inpCredWorksheet.getRow(15).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(15).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(15).getCell(4).getNumericCellValue(),  null, null, 0);
		document.add(cdtrDataTbl);
		//Total the 
		//Creditor Banks Information
		PdfPTable cdtrTotalDataTbl = new PdfPTable(8);
		cdtrTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(cdtrTotalDataTbl, inpCredWorksheet.getRow(16).getCell(2).getNumericCellValue(),  inpCredWorksheet.getRow(16).getCell(3).getNumericCellValue(),  inpCredWorksheet.getRow(16).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(16).getCell(8).getNumericCellValue());
		...
		//MANAM
		createCreditorBankRow(manamTable, inpCredWorksheet.getRow(18).getCell(0).toString(), inpCredWorksheet.getRow(18).getCell(1).toString(), inpCredWorksheet.getRow(18).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(18).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(18).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(18).getCell(6).toString(),  inpCredWorksheet.getRow(18).getCell(7).toString(),  inpCredWorksheet.getRow(18).getCell(8).getNumericCellValue());
		...
		createCreditorBankRow(manamTable, inpCredWorksheet.getRow(27).getCell(0).toString(), inpCredWorksheet.getRow(27).getCell(1).toString(), inpCredWorksheet.getRow(27).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(27).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(27).getCell(4).getNumericCellValue(),  null, null, 0);
		document.add(manamTable);

		//Total the MANAM
		PdfPTable manamTotalDataTbl = new PdfPTable(8);
		manamTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(manamTotalDataTbl, inpCredWorksheet.getRow(28).getCell(2).getNumericCellValue(),  inpCredWorksheet.getRow(28).getCell(3).getNumericCellValue(),  inpCredWorksheet.getRow(28).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(28).getCell(8).getNumericCellValue());
		...
		//MANCN
		createCreditorBankRow(mancnTable, inpCredWorksheet.getRow(30).getCell(0).toString(), inpCredWorksheet.getRow(30).getCell(1).toString(), inpCredWorksheet.getRow(30).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(30).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(30).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(30).getCell(6).toString(),  inpCredWorksheet.getRow(30).getCell(7).toString(),  inpCredWorksheet.getRow(30).getCell(8).getNumericCellValue());
		createCreditorBankRow(mancnTable, inpCredWorksheet.getRow(31).getCell(0).toString(), inpCredWorksheet.getRow(31).getCell(1).toString(), inpCredWorksheet.getRow(31).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(31).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(31).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(31).getCell(6).toString(),  inpCredWorksheet.getRow(31).getCell(7).toString(),  inpCredWorksheet.getRow(31).getCell(8).getNumericCellValue());
		...
		createCreditorBankRow(mancnTable, inpCredWorksheet.getRow(39).getCell(0).toString(), inpCredWorksheet.getRow(39).getCell(1).toString(), inpCredWorksheet.getRow(39).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(39).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(39).getCell(4).getNumericCellValue(),  null, null, 0);
		document.add(mancnTable);

		//Total the MANCN
		PdfPTable mancnTotalDataTbl = new PdfPTable(8);
		mancnTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(mancnTotalDataTbl, inpCredWorksheet.getRow(40).getCell(2).getNumericCellValue(),  inpCredWorksheet.getRow(40).getCell(3).getNumericCellValue(),  inpCredWorksheet.getRow(40).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(40).getCell(8).getNumericCellValue());
		...
		//MANRI
		createCreditorBankRow(manriTable, inpCredWorksheet.getRow(42).getCell(0).toString(), inpCredWorksheet.getRow(42).getCell(1).toString(), inpCredWorksheet.getRow(42).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(42).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(42).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(42).getCell(6).toString(),  inpCredWorksheet.getRow(42).getCell(7).toString(),  inpCredWorksheet.getRow(42).getCell(8).getNumericCellValue());
		createCreditorBankRow(manriTable, inpCredWorksheet.getRow(43).getCell(0).toString(), inpCredWorksheet.getRow(43).getCell(1).toString(), inpCredWorksheet.getRow(43).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(43).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(43).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(43).getCell(6).toString(),  inpCredWorksheet.getRow(43).getCell(7).toString(),  inpCredWorksheet.getRow(43).getCell(8).getNumericCellValue());
		createCreditorBankRow(manriTable, inpCredWorksheet.getRow(44).getCell(0).toString(), inpCredWorksheet.getRow(44).getCell(1).toString(), inpCredWorksheet.getRow(44).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(44).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(44).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(44).getCell(6).toString(),  inpCredWorksheet.getRow(44).getCell(7).toString(),  inpCredWorksheet.getRow(44).getCell(8).getNumericCellValue());
		...
		createCreditorBankRow(manriTable, inpCredWorksheet.getRow(51).getCell(0).toString(), inpCredWorksheet.getRow(51).getCell(1).toString(), inpCredWorksheet.getRow(51).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(51).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(51).getCell(4).getNumericCellValue(),  null, null, 0);
		document.add(manriTable);

		//Total the MANRI
		PdfPTable manriTotalDataTbl = new PdfPTable(8);
		manriTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(manriTotalDataTbl, inpCredWorksheet.getRow(52).getCell(2).getNumericCellValue(),  inpCredWorksheet.getRow(52).getCell(3).getNumericCellValue(),  inpCredWorksheet.getRow(52).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(52).getCell(8).getNumericCellValue());
		...
		//SRINP
		createCreditorBankRow(srinpTable, inpCredWorksheet.getRow(54).getCell(0).toString(), inpCredWorksheet.getRow(54).getCell(1).toString(), inpCredWorksheet.getRow(54).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(54).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(54).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(54).getCell(6).toString(),  inpCredWorksheet.getRow(54).getCell(7).toString(),  inpCredWorksheet.getRow(54).getCell(8).getNumericCellValue());
		createCreditorBankRow(srinpTable, inpCredWorksheet.getRow(55).getCell(0).toString(), inpCredWorksheet.getRow(55).getCell(1).toString(), inpCredWorksheet.getRow(55).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(55).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(55).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(55).getCell(6).toString(),  inpCredWorksheet.getRow(55).getCell(7).toString(),  inpCredWorksheet.getRow(55).getCell(8).getNumericCellValue());
		createCreditorBankRow(srinpTable, inpCredWorksheet.getRow(56).getCell(0).toString(), inpCredWorksheet.getRow(56).getCell(1).toString(), inpCredWorksheet.getRow(56).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(56).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(56).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(56).getCell(6).toString(),  inpCredWorksheet.getRow(56).getCell(7).toString(),  inpCredWorksheet.getRow(56).getCell(8).getNumericCellValue());
		createCreditorBankRow(srinpTable, inpCredWorksheet.getRow(57).getCell(0).toString(), inpCredWorksheet.getRow(57).getCell(1).toString(), inpCredWorksheet.getRow(57).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(57).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(57).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(57).getCell(6).toString(),  inpCredWorksheet.getRow(57).getCell(7).toString(),  inpCredWorksheet.getRow(57).getCell(8).getNumericCellValue());
		...
		createCreditorBankRow(srinpTable, inpCredWorksheet.getRow(63).getCell(0).toString(), inpCredWorksheet.getRow(63).getCell(1).toString(), inpCredWorksheet.getRow(63).getCell(2).getNumericCellValue(), inpCredWorksheet.getRow(63).getCell(3).getNumericCellValue(), inpCredWorksheet.getRow(63).getCell(4).getNumericCellValue(),  null, null, 0);
		document.add(srinpTable);

		//Total the SRINP
		PdfPTable srinpTotalDataTbl = new PdfPTable(8);
		srinpTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(srinpTotalDataTbl, inpCredWorksheet.getRow(64).getCell(2).getNumericCellValue(),  inpCredWorksheet.getRow(64).getCell(3).getNumericCellValue(),  inpCredWorksheet.getRow(64).getCell(4).getNumericCellValue(),  inpCredWorksheet.getRow(64).getCell(8).getNumericCellValue());
		...
		createGrandTotalTables(crBanksGrandTotalDataTbl,  inpCredWorksheet.getRow(66).getCell(2).toString(), inpCredWorksheet.getRow(66).getCell(3).toString(), inpCredWorksheet.getRow(66).getCell(4).toString(), inpCredWorksheet.getRow(66).getCell(8).toString());
		...
		XSSFSheet inpDebtWorksheet = mr020xlsReport.getSheetAt(2); 
		...
		createDebtorBankRow(dbtrDataTbl, null, null, 0, 0, 0,  inpDebtWorksheet.getRow(15).getCell(6).toString(),  inpDebtWorksheet.getRow(15).getCell(7).toString(),  inpDebtWorksheet.getRow(15).getCell(8).getNumericCellValue());
		document.add(dbtrDataTbl);
		//Total the ST101
		//Creditor Banks Information
		PdfPTable dbtrTotalDataTbl = new PdfPTable(8);
		dbtrTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(dbtrTotalDataTbl, inpDebtWorksheet.getRow(15).getCell(2).getNumericCellValue(),  inpDebtWorksheet.getRow(15).getCell(3).getNumericCellValue(),  inpDebtWorksheet.getRow(15).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(16).getCell(8).getNumericCellValue());
		...
		//MANAC
		createDebtorBankRow(manacDataTbl, inpDebtWorksheet.getRow(18).getCell(0).toString(), inpDebtWorksheet.getRow(18).getCell(1).toString(), inpDebtWorksheet.getRow(18).getCell(2).getNumericCellValue(), inpDebtWorksheet.getRow(18).getCell(3).getNumericCellValue(), inpDebtWorksheet.getRow(18).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(18).getCell(6).toString(),  inpDebtWorksheet.getRow(18).getCell(7).toString(),  inpDebtWorksheet.getRow(18).getCell(8).getNumericCellValue());
		...
		createDebtorBankRow(manacDataTbl, null, null, 0, 0, 0,  inpDebtWorksheet.getRow(27).getCell(6).toString(),  inpDebtWorksheet.getRow(27).getCell(7).toString(),  inpDebtWorksheet.getRow(27).getCell(8).getNumericCellValue());
		document.add(manacDataTbl);
		//Total the MANAC
		//Creditor Banks Information
		PdfPTable manacTotalDataTbl = new PdfPTable(8);
		manacTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(manacTotalDataTbl, inpDebtWorksheet.getRow(27).getCell(2).getNumericCellValue(),  inpDebtWorksheet.getRow(27).getCell(3).getNumericCellValue(),  inpDebtWorksheet.getRow(27).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(28).getCell(8).getNumericCellValue());
		...
		//MANRT
		createDebtorBankRow(manrtDataTbl, inpDebtWorksheet.getRow(30).getCell(0).toString(), inpDebtWorksheet.getRow(30).getCell(1).toString(), inpDebtWorksheet.getRow(30).getCell(2).getNumericCellValue(), inpDebtWorksheet.getRow(30).getCell(3).getNumericCellValue(), inpDebtWorksheet.getRow(30).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(30).getCell(6).toString(),  inpDebtWorksheet.getRow(30).getCell(7).toString(),  inpDebtWorksheet.getRow(30).getCell(8).getNumericCellValue());
		createDebtorBankRow(manrtDataTbl, inpDebtWorksheet.getRow(31).getCell(0).toString(), inpDebtWorksheet.getRow(31).getCell(1).toString(), inpDebtWorksheet.getRow(31).getCell(2).getNumericCellValue(), inpDebtWorksheet.getRow(31).getCell(3).getNumericCellValue(), inpDebtWorksheet.getRow(31).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(31).getCell(6).toString(),  inpDebtWorksheet.getRow(31).getCell(7).toString(),  inpDebtWorksheet.getRow(31).getCell(8).getNumericCellValue());
		...
		createDebtorBankRow(manrtDataTbl, null, null, 0, 0, 0,  inpDebtWorksheet.getRow(39).getCell(6).toString(),  inpDebtWorksheet.getRow(39).getCell(7).toString(),  inpDebtWorksheet.getRow(39).getCell(8).getNumericCellValue());
		document.add(manrtDataTbl);
		//Total the MANRT
		//Creditor Banks Information
		PdfPTable manrtTotalDataTbl = new PdfPTable(8);
		manrtTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(manrtTotalDataTbl, inpDebtWorksheet.getRow(39).getCell(2).getNumericCellValue(),  inpDebtWorksheet.getRow(39).getCell(3).getNumericCellValue(),  inpDebtWorksheet.getRow(39).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(40).getCell(8).getNumericCellValue());
		...
		createDebtorBankRow(spinpDataTbl, inpDebtWorksheet.getRow(43).getCell(0).toString(), inpDebtWorksheet.getRow(43).getCell(1).toString(), inpDebtWorksheet.getRow(43).getCell(2).getNumericCellValue(), inpDebtWorksheet.getRow(43).getCell(3).getNumericCellValue(), inpDebtWorksheet.getRow(43).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(43).getCell(6).toString(),  inpDebtWorksheet.getRow(43).getCell(7).toString(),  inpDebtWorksheet.getRow(43).getCell(8).getNumericCellValue());
		createDebtorBankRow(spinpDataTbl, inpDebtWorksheet.getRow(44).getCell(0).toString(), inpDebtWorksheet.getRow(44).getCell(1).toString(), inpDebtWorksheet.getRow(44).getCell(2).getNumericCellValue(), inpDebtWorksheet.getRow(44).getCell(3).getNumericCellValue(), inpDebtWorksheet.getRow(44).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(44).getCell(6).toString(),  inpDebtWorksheet.getRow(44).getCell(7).toString(),  inpDebtWorksheet.getRow(44).getCell(8).getNumericCellValue());
		...
		createDebtorBankRow(spinpDataTbl, null, null, 0, 0, 0,  inpDebtWorksheet.getRow(51).getCell(6).toString(),  inpDebtWorksheet.getRow(51).getCell(7).toString(),  inpDebtWorksheet.getRow(51).getCell(8).getNumericCellValue());
		document.add(spinpDataTbl);
		//Total the SPINP
		//Creditor Banks Information
		PdfPTable spinpTotalDataTbl = new PdfPTable(8);
		spinpTotalDataTbl.setWidthPercentage(100);
		createTotalCreditorBankRow(spinpTotalDataTbl, inpDebtWorksheet.getRow(51).getCell(2).getNumericCellValue(),  inpDebtWorksheet.getRow(51).getCell(3).getNumericCellValue(),  inpDebtWorksheet.getRow(51).getCell(4).getNumericCellValue(),  inpDebtWorksheet.getRow(52).getCell(8).getNumericCellValue());
		...
		createGrandTotalTables(drBanksGrandTotalDataTbl,  inpDebtWorksheet.getRow(54).getCell(2).toString(), inpDebtWorksheet.getRow(54).getCell(3).toString(), inpDebtWorksheet.getRow(54).getCell(4).toString(), inpDebtWorksheet.getRow(54).getCell(8).toString());
		...
		XSSFSheet stsRepWorksheet = mr020xlsReport.getSheetAt(3); 
		...
		PdfPCell gtNrOfTxns = new PdfPCell(new Phrase(stsRepWorksheet.getRow(53).getCell(2).getStringCellValue(),FontFactory.getFont(FontFactory.HELVETICA, 8,com.itextpdf.text.Font.BOLD)));
		...
		PdfPCell gtExtTxns = new PdfPCell(new Phrase(stsRepWorksheet.getRow(53).getCell(6).getStringCellValue(),FontFactory.getFont(FontFactory.HELVETICA, 8,com.itextpdf.text.Font.BOLD)));
