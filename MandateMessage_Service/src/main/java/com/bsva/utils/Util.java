...
public class Util {
	...
	public static ServiceBeanRemote getServiceBean() {
		...
		try {
			...
			e.printStackTrace();
			log.debug("Error on getServiceBean()");
		}
		return null;
	...
	public static FileProcessBeanRemote getFileProcessBean() {
		if (ic == null) 
		{
			setContext(); 
		}
		...
		{
			log.debug("Error on getFileProcessBean(): "+e.getMessage());
			e.printStackTrace();	
			return null;
		}
	}
	...
	//public static EJBSchedulerBeanRemote getEJBScheduler() 
	//{
	//		
	//		if (ic == null) 
	//		{
	...
	//		{
	//			e.printStackTrace();
	//			log.debug("Error on getEJBScheduler(): "+e.getMessage());
	//		}
	//		return null;
	//		
	//	}
